...
export const dataCourses = [
  new Course(
    ...
    'https://i0.wp.com/imgs.hipertextual.com/wp-content/uploads/2022/06/breaking-bad-2.jpeg'
  ),
  ...
  new Course(
    ...
    'https://img.buzzfeed.com/buzzfeed-static/static/2018-10/17/17/asset/buzzfeed-prod-web-02/sub-buzz-14699-1539812613-8.png'
  ),
  ...
  new Course(
    ...
    'https://www.eltiempo.com/files/article_main/uploads/2022/07/19/62d6c68bda149.png'
  ),
  ...
  new Course(
    ...
    'https://depor.com/resizer/4PPpqZ53w5NOBLF81-S1z0NFziY=/580x330/smart/filters:format(jpeg):quality(90)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/OJXV37HADFHXNGRVWWKDQCBHL4.jpg'
  ),
  ...
  new Course(
    ...
    'https://pics.filmaffinity.com/sherlock-635342236-large.jpg'
  ),
  ...
  new Course(
    ...
    'https://resizing.flixster.com/IkL4tjmy85sdsuHZWEy7Apu9Sw8=/206x305/v2/https://resizing.flixster.com/-XZAfHZM39UwaGJIFWKAE8fS0ak=/v3/t/assets/p15526450_b_v10_ah.png'
  ),
];
